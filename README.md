# Analizador Financiero · PWA edition

Versión instalable (PWA) con sincronización entre dispositivos via GitHub y datos en vivo de Yahoo Finance / Financial Modeling Prep.
...
1. Crear repo público en GitHub: `tu-usuario/analizador-financiero`
2. Subir los 5 archivos al repo (puedes arrastrarlos en la web de GitHub)
3. Settings → Pages → Source: `main` branch
4. Esperar ~1 min, tendrás la URL `https://tu-usuario.github.io/analizador-financiero/`
...
2. Drag-and-drop la carpeta `analizador_pwa/`
...
## Funcionalidades nuevas vs versión académica

### 1. Cargar empresas internacionales por ticker (FMP)

En la pestaña **Análisis financiero** ahora hay un selector: SABI / FMP.
- **SABI**: empresas españolas, sube el .xlsx como siempre
- **FMP**: cualquier empresa cotizada del mundo (AAPL, MSFT, ITX.MC, TEF.MC...)
...
### 3. Sincronización entre dispositivos (GitHub)
...
1. Crear repo **privado** vacío en github.com/new (ej: `sabi-analyzer-data`). Marca *Private*.
...
4. En la app: **Ajustes** → sección GitHub → pega token y `tu-usuario/sabi-analyzer-data`
